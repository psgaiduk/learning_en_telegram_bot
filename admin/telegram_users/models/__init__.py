...
from telegram_users.models.history_books_sentences import (
    UsersBooksSentencesHistoryModel,
)
...
from telegram_users.models.referrals import UserReferralsModel
