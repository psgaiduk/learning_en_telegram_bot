...
Другое предложение на английском --- Перевод этого предложения --- Сложные слова с переводом --- Время предложения --- Объяснение почему именно это время
...
состоящий из 20 предложений, подходящий для обучения английскому языку. 
        ...
        переведенные на русский язык в скобках [].  За исключение имён собственных. В скобах должно быть написано слово на английском и на русском [word - слово]  через тире. Перевод слов нужно давать сразу после слова.
        ...
        В конце каждого предложения дай его перевод на русский через --- .  Сразу после этого через --- Напиши какое время тут используется. Сразу после этого через --- сделай разбор предложения, объясни грамматику в этом предложении, с приведением правил
