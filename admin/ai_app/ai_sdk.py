...
"""
    ...
    def generate_text(self, text: str) -> str:
        ...
        состоящий из 10 предложений, подходящий для обучения английскому языку. 
        Текст должен быть адаптирован для уровня сложности A1. 
        Каждое предложение должно включать слова или фразы, 
        переведенные на русский язык в скобках [] а слова на английском, 
        которые переведены должны быть выделены знаком  '-' с двух сторон. 
        ...
        Так же не надо переводить имена собственные. 
